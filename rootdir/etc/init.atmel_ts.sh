...
#update firmware
echo "A4_07_1.6_AA.fw" > update_fw
...
echo "A4_07_1.6_AA.raw" > update_cfg
...
#enable gesture feature ,need platform to control en_gesture
#echo 1 > en_gesture
